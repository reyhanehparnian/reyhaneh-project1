...
/**
 * The PlayGame class serves as the main program for playing through a version of Welter’s Game.
 *
 * @author rparnian
 * @version 1.0 Build 2024.02.18
 */
public class BonusPlayGame {
    public static void main(String[] args) {
        ...
        BonusCoinStrip strip1 = new BonusCoinStrip(numCoins);
     ...
     * @param strip1 The BonusCoinStrip game instance.
     * @return An array with two items: the coin index and the number of squares to move.
     */
    private static int[] getValidMove(Scanner input, BonusCoinStrip strip1) {
        while (true) {
